...
export default function Documentation() {
  ...
  const languageOptions = [
    { code: 'en', label: 'English (EN)', tabLabel: 'English' },
    { code: 'hi', label: 'हिंदी (Hindi)', tabLabel: 'हिंदी' },
    { code: 'gu', label: 'ગુજરાતી (Gujarati)', tabLabel: 'ગુજરાતી' }
  ]
    ...
    >
      ...
      <div className="px-5 py-3 border-b border-border/60 bg-surface-secondary/40 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-sm font-bold text-text-secondary pl-2 border-l border-border/60">
            {title || caption}
          </span>
        </div>
      ...
      <div className="relative overflow-hidden w-full max-h-[520px] bg-black/[0.02] dark:bg-black/20 flex items-center justify-center p-3 sm:p-5">
        ...
        <div className="absolute inset-0 bg-primary/15 backdrop-blur-[2px] opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center gap-2">
          <div className="px-5 py-2.5 rounded-xl bg-surface/95 text-primary font-bold text-sm shadow-2xl border border-primary/30 flex items-center gap-2 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
      ...
      {/* Caption Bottom Bar */}
      {caption && (
        <div className="px-5 py-3 bg-surface border-t border-border/70 flex items-center justify-between text-sm sm:text-base text-text-secondary">
          ...
          {languageOptions.map((opt) => {
            ...
            return (
              <button
                ...
                className={`px-3.5 py-1.5 rounded-lg text-sm font-semibold transition-all cursor-pointer flex items-center gap-2 ${isSelected
            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center justify-between gap-3 px-3.5 py-3 min-h-[46px] rounded-xl text-sm sm:text-[13.5px] font-bold transition-all text-left group cursor-pointer leading-relaxed ${isActive
        ...
        >
          ...
          <section id="overview" className="bg-surface border border-border/80 rounded-3xl p-5 lg:p-6 shadow-glass-md flex flex-col justify-between min-h-full space-y-4">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-b border-border/80 pb-3.5 shrink-0">
              <div className="space-y-1 max-w-3xl">
                <h2 className="text-2xl lg:text-3xl font-black text-text tracking-tight leading-tight">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-stretch flex-1">
              ...
              <div className="lg:col-span-5 flex flex-col justify-between gap-4">
                ...
                {/* <div className="p-3.5 rounded-2xl bg-primary/8 border border-primary/20 flex items-center gap-3 text-sm text-text-secondary shadow-xs">
                  <div className="w-6 h-6 rounded-full bg-primary/15 text-primary flex items-center justify-center font-bold text-sm shrink-0">
                    ℹ
                  </div>
                ...
                <div className="p-5 sm:p-6 rounded-3xl bg-surface-secondary/40 border border-border/80 space-y-4 shadow-sm flex-1 flex flex-col justify-between relative overflow-hidden">
                  ...
                  <div className="space-y-2 border-b border-border/60 pb-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2.5 text-base sm:text-lg font-extrabold text-primary">
                        <div className="w-6 h-6 rounded-full border-2 border-primary flex items-center justify-center">
                          <div className="w-2.5 h-2.5 rounded-full bg-primary"></div>
                        </div>
                        <span>{t.sections.overview.whyTitle}</span>
                      </div>
                      {/* <span className="text-xs font-bold uppercase tracking-wider text-primary bg-primary/10 px-2 py-0.5 rounded-md border border-primary/20">
                        Unified Ecosystem
                      </span> */}
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-12 gap-3 items-center flex-1 py-1">
                    ...
                    <div className="sm:col-span-12 space-y-2">
                      {t.sections.overview.whyPoints.map((point, i) => (
                        <div key={i} className="flex items-start gap-2.5 text-sm text-text-secondary leading-relaxed p-1.5 rounded-lg hover:bg-surface/60 transition-colors">
                          <div className="w-4 h-4 rounded-full bg-primary/10 text-primary flex items-center justify-center shrink-0 mt-0.5 font-bold text-xs">
                            ✓
                          </div>
                          <div className="min-w-0">
                            <span className="font-bold text-text">{typeof point === 'object' ? point.title : point}</span>
                            {typeof point === 'object' && point.desc && (
                              <p className="text-sm text-text-secondary leading-snug line-clamp-1">{point.desc}</p>
                            )}
                          </div>
                        </div>
                      ))}
                    ...
                    {/* <div className="sm:col-span-4 flex flex-col items-center justify-center gap-2">
                      <div className="w-24 h-24 rounded-full border-4 border-primary/20 flex items-center justify-center relative bg-primary/5 shadow-inner">
                        ...
                        <div className="absolute -top-1 -right-1 w-6 h-6 bg-primary text-white rounded-full flex items-center justify-center text-xs shadow-sm transform rotate-45">
                          ➹
                        </div>
                      </div>
                      <span className="text-xs font-extrabold text-primary uppercase tracking-wider text-center">
                        Goal-Driven
                      </span>
                    </div> */}
                  </div>
                ...
                <div className="p-4 sm:p-4.5 rounded-2xl bg-surface-secondary/30 border border-border/80 space-y-2 text-sm text-text-secondary shrink-0 shadow-xs">
                  <div className="font-bold text-text flex items-center gap-2 text-sm sm:text-base">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-3.5 min-w-0">
                          {/* Number Circle Badge */}
                          <div className="w-8 h-8 rounded-full bg-surface text-text-secondary border border-border group-hover:border-primary group-hover:bg-primary group-hover:text-white font-black text-sm flex items-center justify-center shrink-0 transition-colors shadow-xs">
                            {i + 1}
                          </div>
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="text-sm sm:text-sm text-text-secondary leading-snug line-clamp-1 pt-0.5">
                              {step.desc}
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-xl border  group-hover:border-primary/40 bg-surface-secondary/40 group-hover:bg-primary group-hover:text-white text-text-secondary text-sm font-bold transition-all shrink-0 shadow-2xs">
                          <span>More</span>
          ...
          <section id="dashboard" className="bg-surface border border-border/80 rounded-2xl p-7 lg:p-8 shadow-sm space-y-6">
            <div className="flex items-center justify-between border-b border-border pb-4">
              <div>
                <span className="text-sm font-extrabold uppercase tracking-wider text-primary bg-primary/10 px-3 py-1 rounded-full border border-primary/20">
                  {t.sections.dashboard.badge}
                </span>
                <h2 className="text-2xl lg:text-3xl font-extrabold text-text mt-2.5">{t.sections.dashboard.title}</h2>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {t.sections.dashboard.features.map((f, i) => (
                <div key={i} className="p-5 rounded-2xl bg-surface-secondary/35 border border-border/80 space-y-2">
                  <h4 className="text-sm sm:text-base font-bold text-text flex items-center gap-2">
          ...
          <section id="members" className="bg-surface border border-border/80 rounded-2xl p-7 lg:p-8 shadow-sm space-y-6">
            <div className="flex items-center justify-between border-b border-border pb-4">
              <div>
                ...
                <h2 className="text-2xl lg:text-3xl font-extrabold text-text mt-2.5">{t.sections.members.title}</h2>
              </div>
            </div>

            <div className="space-y-3 p-5 rounded-2xl bg-surface-secondary/25 border border-border/80">
              {t.sections.members.points.map((p, i) => (
                <div key={i} className="flex items-start gap-3 text-sm sm:text-base text-text-secondary leading-relaxed">
          ...
          <section id="committee" className="bg-surface border border-border/80 rounded-2xl p-7 lg:p-8 shadow-sm space-y-6">
            <div className="flex items-center justify-between border-b border-border pb-4">
              <div>
                ...
                <h2 className="text-2xl lg:text-3xl font-extrabold text-text mt-2.5">{t.sections.committee.title}</h2>
              </div>
            </div>
          ...
          <section id="roles" className="bg-surface border border-border/80 rounded-2xl p-7 lg:p-8 shadow-sm space-y-6">
            <div className="flex items-center justify-between border-b border-border pb-4">
              <div>
                ...
                <h2 className="text-2xl lg:text-3xl font-extrabold text-text mt-2.5">{t.sections.roles.title}</h2>
              </div>
            </div>
          ...
          <section id="activities" className="bg-surface border border-border/80 rounded-2xl p-7 lg:p-8 shadow-sm space-y-6">
            <div className="flex items-center justify-between border-b border-border pb-4">
              <div>
                ...
                <h2 className="text-2xl lg:text-3xl font-extrabold text-text mt-2.5">{t.sections.activities.title}</h2>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {t.sections.activities.tabs.map((tab, i) => (
                <div key={i} className="p-5 rounded-2xl bg-surface-secondary/35 border border-border/80 space-y-2">
                  <h4 className="text-sm sm:text-base font-bold text-primary">{tab.name}</h4>
          ...
          <section id="services" className="bg-surface border border-border/80 rounded-2xl p-7 lg:p-8 shadow-sm space-y-6">
            <div className="flex items-center justify-between border-b border-border pb-4">
              <div>
                ...
                <h2 className="text-2xl lg:text-3xl font-extrabold text-text mt-2.5">{t.sections.services.title}</h2>
              </div>
            </div>
          ...
          <section id="media" className="bg-surface border border-border/80 rounded-2xl p-7 lg:p-8 shadow-sm space-y-6">
            <div className="flex items-center justify-between border-b border-border pb-4">
              <div>
                ...
                <h2 className="text-2xl lg:text-3xl font-extrabold text-text mt-2.5">{t.sections.media.title}</h2>
              </div>
            </div>
          ...
          <section id="engagements" className="bg-surface border border-border/80 rounded-2xl p-7 lg:p-8 shadow-sm space-y-6">
            <div className="flex items-center justify-between border-b border-border pb-4">
              <div>
                ...
                <h2 className="text-2xl lg:text-3xl font-extrabold text-text mt-2.5">{t.sections.engagements.title}</h2>
              </div>
            </div>
          ...
          <section id="masters" className="bg-surface border border-border/80 rounded-2xl p-7 lg:p-8 shadow-sm space-y-6">
            <div className="flex items-center justify-between border-b border-border pb-4">
              <div>
                ...
                <h2 className="text-2xl lg:text-3xl font-extrabold text-text mt-2.5">{t.sections.masters.title}</h2>
              </div>
            </div>
          ...
          <section id="settings" className="bg-surface border border-border/80 rounded-2xl p-7 lg:p-8 shadow-sm space-y-6">
            <div className="flex items-center justify-between border-b border-border pb-4">
              <div>
                ...
                <h2 className="text-2xl lg:text-3xl font-extrabold text-text mt-2.5">{t.sections.settings.title}</h2>
              </div>
            </div>
        ...
        {lightboxImage && (
          ...
          >
            ...
            >
              ...
              {/* Modal Footer */}
              <div className="px-6 py-2.5 bg-surface border-t border-border flex items-center justify-between text-sm text-text-secondary">
